      ...
      <div class="content">
        ...
        <div class="tabs">
          <div class="l-coupon-list" v-show="tabIndex === 1">
            <div class="l-coupon-item l-link l-margin-b" v-for="item in couponList1" :key="item.id">
          ...
          <div class="l-coupon-list l-coupon-invalid" v-show="tabIndex === 2">
            <div class="l-coupon-item l-link l-margin-b" v-for="item in couponList2" :key="item.id">
              <div class="_bd l-flex-hc">
                <div class="_val l-border-r">
                  <i class="l-icon">&#xe6cb;</i><span v-text="item.coupon_charge"></span>
                </div>
...
export default {
  ...
  methods: {
    getCoupons(page, row, type) {
      this.$server.user.getCoupons(page, row, type)
      .then(({list})=>{
